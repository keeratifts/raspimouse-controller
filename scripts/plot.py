...
def plot_feedback_control(log_file_1, log_file_2, log_file_3):
    ...
    x_traj_1, y_traj_1, theta_traj_1, x_goal_1, y_goal_1, theta_goal_1, k_rho_1, k_alpha_1, k_beta_1, v_const_1 = extract(log_file_1)
    x_traj_2, y_traj_2, theta_traj_2, x_goal_2, y_goal_2, theta_goal_2, k_rho_2, k_alpha_2, k_beta_2, v_const_2 = extract(log_file_2)
    x_traj_3, y_traj_3, theta_traj_3, x_goal_3, y_goal_3, theta_goal_3, k_rho_3, k_alpha_3, k_beta_3, v_const_3 = extract(log_file_3)
